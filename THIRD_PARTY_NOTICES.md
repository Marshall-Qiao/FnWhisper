...
- [llama.cpp](https://github.com/ggml-org/llama.cpp), MIT License. It is installed separately through Homebrew and serves Qwen only on the local loopback interface.
- [Qwen3-4B-Instruct-2507](https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507), Apache License 2.0. The setup script downloads the pinned Q4_K_M conversion from [unsloth/Qwen3-4B-Instruct-2507-GGUF](https://huggingface.co/unsloth/Qwen3-4B-Instruct-2507-GGUF) for local text cleanup.
...
- [llama.cpp](https://github.com/ggml-org/llama.cpp)，MIT License；通过 Homebrew 独立安装，只在本机回环地址上运行 Qwen。
- [Qwen3-4B-Instruct-2507](https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507)，Apache License 2.0；安装脚本从 [unsloth/Qwen3-4B-Instruct-2507-GGUF](https://huggingface.co/unsloth/Qwen3-4B-Instruct-2507-GGUF) 下载固定 revision 的 Q4_K_M 转换文件，用于本地文字整理。
