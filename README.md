...
# Narrative should remain a paragraph; real parallel actions should be numbered
.build/FnWhisper.app/Contents/MacOS/FnWhisper --test-text-refinement "I investigated the logs, then found the cause, so I will keep monitoring it"
.build/FnWhisper.app/Contents/MacOS/FnWhisper --test-text-refinement "I have three tasks: test the change, deploy it, and report the result"
